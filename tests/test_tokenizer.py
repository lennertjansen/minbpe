...
test_strings = [
    ...
    "FILE:manhattanproject.txt", # FILE: is handled as a special string in unpack()
]
def unpack(text):
    ...
    if text.startswith("FILE:"):
        ...
        manhattanproject_file = os.path.join(dirname, text[5:])
        contents = open(manhattanproject_file, "r", encoding="utf-8").read()
        return contents
    else:
        return text
